...
def test_get_sample_size_multi_candidate():
    ...
    arlo3 = minerva.make_arlo_contest({"a": 5040799, "b": 10000000 - 5040799, "c": 1000000})
...
def test_get_sample_size_2win():
    ...
    res = minerva2.get_sample_size(10, d2, None, [])
    assert res == {
    ...
    res = minerva2.get_sample_size(10, d2, sample_results, round_schedule)
    assert res == {
...
def test_get_sample_size_multiple_rounds():
    ...
    assert r2b2_result == arlo_result
    #TODO: Figure out why this is broken hehe
