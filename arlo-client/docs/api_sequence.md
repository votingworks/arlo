...
### The next /audit/status response
...
- `POST /election/{electionId}/jurisdiction/<jurisdiction_id>/manifest` -- the
  ballot manifest straight file upload `multipart/form-data`
