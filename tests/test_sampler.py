...
def macro_contest():
    ...
    info_dict = {'cand1': 600, 'cand2': 400, 'ballots': 1000, 'numWinners': 1, 'votesAllowed': 1}
...
def test_draw_macro_sample(macro_batches, macro_contest):
    # Test getting a sample
    sample = sampler.draw_ppeb_sample(seed, macro_contest, {}, 10, batch_results=macro_batches)
...
def test_draw_more_macro_sample(macro_batches, macro_contest):
    # Test getting a sample
    samp_size = 5
    sample = sampler.draw_ppeb_sample(seed,
                                      macro_contest, {},
                                      samp_size,
